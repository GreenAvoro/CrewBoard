...
function SidePanel(props) {
    ...
    const [menuCollapse, updateMenuCollapse] = useState(true)
    ...
    return (
        <div className="side-panel">
            <div className="menu-button" onClick={() => updateMenuCollapse(prevState => !prevState)}>Menu &#9776;</div>
            <div className={menuCollapse ? "menu-collapse" : "nothing"}>
